#!/usr/bin/env python3
"""
Python wrapper for VRM2 Right Arm regressor C functions.
...
def find_library():
    ...
    possible_paths = [
        script_dir / "libright_arm_regressor.so",
        script_dir / "build" / "libright_arm_regressor.so",
        script_dir.parent.parent / "c" / "build" / "libright_arm_regressor.so",
        script_dir.parent.parent / "py" / "build" / "libright_arm_regressor.so",
    ]
    ...
    try:
        import ctypes.util
        lib_path = ctypes.util.find_library("right_arm_regressor")
        if lib_path:
            return lib_path
    except:
        pass
...
class RightArmRegressor:
    ...
    def _setup_function_signatures(self):
        ...
        # right_arm_regressor: (q[7], v[7], a[7], g[3]) -> Phi[7x70]
        self.lib.right_arm_regressor.argtypes = [
        ...
        self.lib.right_arm_regressor.restype = ctypes.c_int
        
        # right_arm_regressor_work
        self.lib.right_arm_regressor_work.argtypes = [
            casadi_int_p,  # sz_arg
            casadi_int_p,  # sz_res
            casadi_int_p,  # sz_iw
            casadi_int_p   # sz_w
        ]
        self.lib.right_arm_regressor_work.restype = ctypes.c_int
        
        # right_arm_params_to_X: (70 params) -> X[70]
        self.lib.right_arm_params_to_X.argtypes = [
            ctypes.POINTER(casadi_real_p),  # arg
            ctypes.POINTER(casadi_real_p),  # res
            casadi_int_p,                   # iw
            casadi_real_p,                  # w
        ...
        self.lib.right_arm_params_to_X.restype = ctypes.c_int
        
        # right_arm_params_to_X_work
        self.lib.right_arm_params_to_X_work.argtypes = [
            casadi_int_p,  # sz_arg
            casadi_int_p,  # sz_res
            casadi_int_p,  # sz_iw
            casadi_int_p   # sz_w
        ]
        self.lib.right_arm_params_to_X_work.restype = ctypes.c_int
        
        # right_arm_tau_from_regressor: (X[70], q[7], v[7], a[7], g[3]) -> tau[7]
        self.lib.right_arm_tau_from_regressor.argtypes = [
            ctypes.POINTER(casadi_real_p),  # arg
            ctypes.POINTER(casadi_real_p),  # res
            casadi_int_p,                   # iw
            casadi_real_p,                  # w
        ...
        self.lib.right_arm_tau_from_regressor.restype = ctypes.c_int
        
        # right_arm_tau_from_regressor_work
        self.lib.right_arm_tau_from_regressor_work.argtypes = [
            casadi_int_p,  # sz_arg
            casadi_int_p,  # sz_res
            casadi_int_p,  # sz_iw
            casadi_int_p   # sz_w
        ]
        self.lib.right_arm_tau_from_regressor_work.restype = ctypes.c_int

        # right_arm_regressor_base: (q[7], v[7], a[7], g[3]) -> Phi_base[7x45]
        self.lib.right_arm_regressor_base.argtypes = [
            ctypes.POINTER(casadi_real_p),  # arg
            ctypes.POINTER(casadi_real_p),  # res
            casadi_int_p,                   # iw
            casadi_real_p,                  # w
        ...
        self.lib.right_arm_regressor_base.restype = ctypes.c_int
        
        # right_arm_regressor_base_work
        self.lib.right_arm_regressor_base_work.argtypes = [
            casadi_int_p,  # sz_arg
            casadi_int_p,  # sz_res
            casadi_int_p,  # sz_iw
            casadi_int_p   # sz_w
        ]
        self.lib.right_arm_regressor_base_work.restype = ctypes.c_int
        
        # right_arm_params_to_X_base: (70 params) -> X_base[45]
        self.lib.right_arm_params_to_X_base.argtypes = [
            ctypes.POINTER(casadi_real_p),  # arg
            ctypes.POINTER(casadi_real_p),  # res
            casadi_int_p,                   # iw
            casadi_real_p,                  # w
        ...
        self.lib.right_arm_params_to_X_base.restype = ctypes.c_int
        
        # right_arm_params_to_X_base_work
        self.lib.right_arm_params_to_X_base_work.argtypes = [
            casadi_int_p,  # sz_arg
            casadi_int_p,  # sz_res
            casadi_int_p,  # sz_iw
            casadi_int_p   # sz_w
        ]
        self.lib.right_arm_params_to_X_base_work.restype = ctypes.c_int
        
        # right_arm_tau_from_regressor_base: (X_base[45], q[7], v[7], a[7], g[3]) -> tau[7]
        self.lib.right_arm_tau_from_regressor_base.argtypes = [
            ctypes.POINTER(casadi_real_p),  # arg
            ctypes.POINTER(casadi_real_p),  # res
            casadi_int_p,                   # iw
            casadi_real_p,                  # w
        ...
        self.lib.right_arm_tau_from_regressor_base.restype = ctypes.c_int
        
        # right_arm_tau_from_regressor_base_work
        self.lib.right_arm_tau_from_regressor_base_work.argtypes = [
            casadi_int_p,  # sz_arg
            casadi_int_p,  # sz_res
            casadi_int_p,  # sz_iw
            casadi_int_p   # sz_w
        ]
        self.lib.right_arm_tau_from_regressor_base_work.restype = ctypes.c_int
    ...
    def _init_memory(self):
        ...
        self.lib.right_arm_regressor_work(
        ...
        self.lib.right_arm_params_to_X_work(
            ctypes.byref(sz_arg), ctypes.byref(sz_res),
            ctypes.byref(sz_iw), ctypes.byref(sz_w)
        )
        ...
        self.lib.right_arm_tau_from_regressor_work(
            ctypes.byref(sz_arg), ctypes.byref(sz_res),
            ctypes.byref(sz_iw), ctypes.byref(sz_w)
        )
        ...
        self.lib.right_arm_regressor_base_work(
            ctypes.byref(sz_arg), ctypes.byref(sz_res),
            ctypes.byref(sz_iw), ctypes.byref(sz_w)
        )
        ...
        self.lib.right_arm_params_to_X_base_work(
            ctypes.byref(sz_arg), ctypes.byref(sz_res),
            ctypes.byref(sz_iw), ctypes.byref(sz_w)
        )
        ...
        self.lib.right_arm_tau_from_regressor_base_work(
            ctypes.byref(sz_arg), ctypes.byref(sz_res),
            ctypes.byref(sz_iw), ctypes.byref(sz_w)
        )
    ...
    def compute_regressor(self, q, v, a, g):
        ...
        # Call function
        ret = self.lib.right_arm_regressor(
            arg, res,
            iw if iw else None,
            w if w else None,
            0  # mem
        ...
        if ret != 0:
            raise RuntimeError(f"right_arm_regressor returned error code: {ret}")
    ...
    def params_to_X(self, *params):
        ...
        # Call function
        ret = self.lib.right_arm_params_to_X(
            arg, res,
            iw if iw else None,
            w if w else None,
            0  # mem
        ...
        if ret != 0:
            raise RuntimeError(f"right_arm_params_to_X returned error code: {ret}")
    ...
    def compute_tau_from_regressor(self, X, q, v, a, g):
        ...
        # Call function
        ret = self.lib.right_arm_tau_from_regressor(
            arg, res,
            iw if iw else None,
            w if w else None,
            0  # mem
        ...
        if ret != 0:
            raise RuntimeError(f"right_arm_tau_from_regressor returned error code: {ret}")
    ...
    def params_to_X_base(self, *params):
        ...
        # Call function
        ret = self.lib.right_arm_params_to_X_base(
            arg, res,
            iw if iw else None,
            w if w else None,
            0  # mem
        ...
        if ret != 0:
            raise RuntimeError(f"right_arm_params_to_X_base returned error code: {ret}")
    ...
    def compute_regressor_base(self, q, v, a, g):
        ...
        # Call function
        ret = self.lib.right_arm_regressor_base(
            arg, res,
            iw if iw else None,
            w if w else None,
            0  # mem
        ...
        if ret != 0:
            raise RuntimeError(f"right_arm_regressor_base returned error code: {ret}")
    ...
    def compute_tau_from_regressor_base(self, X_base, q, v, a, g):
        ...
        # Call function
        ret = self.lib.right_arm_tau_from_regressor_base(
            arg, res,
            iw if iw else None,
            w if w else None,
            0  # mem
        ...
        if ret != 0:
            raise RuntimeError(f"right_arm_tau_from_regressor_base returned error code: {ret}")
        
        return tau

if __name__ == "__main__":
    # Simple test
    print("Testing RightArmRegressor wrapper...")
